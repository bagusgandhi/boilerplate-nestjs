...
export class SchemaUpdate1736173211547 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "mv_maintenance_log_monthly_keping_roda_avg" ("id" uuid NOT NULL, "month_year" TIMESTAMP WITH TIME ZONE NOT NULL, "asset_name" character varying(20) NOT NULL, "train_set" character varying(20) NOT NULL, "gerbong" character varying(20) NOT NULL, "details" jsonb, "bogie_type" character varying(20), "bogie" character varying(20), "avg_diameter" double precision, "avg_flens" double precision, "total_records" integer NOT NULL, CONSTRAINT "PK_dacd70bf96d5b1366e8f9632b63" PRIMARY KEY ("id"))`);
