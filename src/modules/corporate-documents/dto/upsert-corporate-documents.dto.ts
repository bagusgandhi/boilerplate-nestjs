import {
  ...
  export class UpsertCorporateDocumentsDto {
    @ApiProperty({
    ...
    @ApiProperty({
      ...
      description: 'The number of the corporate documents',
      required: true,
    })
    @IsString()
    @IsNotEmpty()
    ...
    @ApiProperty({
      example: 'YYYY-MM-DD',
      description: 'start date corporate documents',
      required: true,
    })
    @IsDateString()
    @IsNotEmpty()
    ...
    @ApiProperty({
      example: 'YYYY-MM-DD',
      description: 'end date corporate documents',
      required: true,
    })
    @IsDateString()
    @IsNotEmpty()
